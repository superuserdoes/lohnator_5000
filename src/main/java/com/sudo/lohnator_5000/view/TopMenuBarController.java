...
import com.sudo.lohnator_5000.controller.Settings;
...
import com.sudo.lohnator_5000.services.Stopwatch;
...
public class TopMenuBarController {
    ...
    private void onSettings(){
        ...
        FXMLLoader fxmlLoader = new FXMLLoader(this.getClass().getResource("/com/sudo/lohnator_5000/settings/settings.fxml"));
    ...
    private void onAbout(ActionEvent event){
        ...
        fxmlLoader.setLocation(getClass().getResource("/com/sudo/lohnator_5000/topmenu/about.fxml"));
