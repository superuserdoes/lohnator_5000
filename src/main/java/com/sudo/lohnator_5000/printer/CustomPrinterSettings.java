package com.sudo.lohnator_5000.printer;
...
//        }
    ...
    public void display(final String title, final String message) {
        ...
        window.getIcons().add(new Image(getClass().getResourceAsStream("/com/sudo/lohnator_5000/logo/logo.png")));
...
//        System.out.println(this.getClass().getResource("/com/sudo/gehaltor/main_window/printer.fxml"));
        window = new Stage();
        FXMLLoader fxmlLoader = new FXMLLoader(this.getClass().getResource("/com/sudo/lohnator_5000/main_window/printer.fxml"));
